...
\node[docn]     (D9)  at (13,-9)  {\DN{NAV checklist, BAS checklist, Distribution checklist signed}};
...
\draw[ar] (S9.east) -- (R9.west);

%% R9 Yes → FIX  (issues found — return to preparer to clear all)
\draw[ar] (R9.east) -- node[lb,above]{Yes} (FIX.west);

%% FIX → S8  (re-submit loop — corridor y=-1.5, west to S8.north)
\draw[ar] (FIX.north) -- (20,-1.5) -- (6,-1.5) -- (S8.north);

%% R9 No → D9  (no issues — checklists signed as clean confirmation)
%%   Route: R9.south → straight down into D9.north (both at x=13).
\draw[ar] (R9.south) -- node[lb,right]{No} (D9.north);

%% D9 → S10  (signed checklists — proceed to CPG distribution)
%%   Route: D9.west → left to x=3.5 → south to y=-11.5 → east into S10.west.
\draw[ar] (D9.west) -- (3.5,-9) -- (3.5,-11.5) -- (S10.west);
...
\draw[ar] (RESUB.south) -- (23,-13.0) -- (6,-13.0) -- (S10.south);
