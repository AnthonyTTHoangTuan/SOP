...
\draw[ar] (D1.east) -- (15,-2.5) -- (15,-9.0) -- (S3.north east);
...
\draw[ar] (D2.south) -- (11,-7.8) -- (4,-7.8) -- (S3.north);
...
\draw[ar] (FCN.north) -- (16.5,-4.2) -- (0.8,-4.2) -- (0.8,-1.3) -- (5.5,-1.3) -- (S4.north);
...
%% F7d → S7d  (loop: west to x=3.5 corridor, south under S7d, up into S7d.south)
\draw[ar] (F7d.west) -- (3.5,-11.8) -- (3.5,-10.5) -- (6,-10.5) -- (S7d.south);
...
\node[dec]      (R9b) at (18,-8.5) {Checks\\failed?};
...
%% R9b Yes → RET  (checks failed — return to preparer)
\draw[ar] (R9b.east) -- node[lb,above]{Yes} (RET.west);
...
%% R9b No → S10  (DEPENDENCY: no failures — send to CPG)
...
\draw[ar] (R9b.south) -- node[lb,right]{No} (18,-10.0) -- (6,-10.0) -- (S10.north);
...
%%   CROSSING FIX: previously R10.south dropped at x=18 through y=-13.0,
%%   crossing the RESUB→S10 horizontal corridor.
%%   Now: exit R10.north → north to y=-10.6 (between R9b→S10 at y=-10.0
%%   and RESUB corridor at y=-13.0) → west to x=8 (ARC x-position) →
%%   south to ARC.north. Zero crossings.
\draw[ar] (R10.north) -- node[lb,right]{No} (18,-10.6) -- (8,-10.6) -- (ARC.north);
